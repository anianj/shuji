...
export const fetchGoogleTranslate = (option?: TranslateOptions) => {
    ...
    // let url = `https://translate.google.cn/translate_a/single?client=webapp&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&ie=UTF-8&oe=UTF-8&source=btn&rom=1&srcrom=1&ssel=0&tsel=0&kc=0`
